...
class InvoicePDF(FPDF):
    ...
    def build_content(self):
        ...
        # Invoice Title
        invoice_num = f"F/{self.rental.actual_return_date.strftime('%Y/%m')}/{self.rental.id}"
        ...
        self.cell(95, 8, f"Name: {self.rental.user.username} Email: {self.rental.user.email}", ln=1)
        self.ln(10)
        ...
        self.cell(90, 10, f"Rent {self.rental.car.brand} {self.rental.car.model}", border=1)
